    ...
    resources: {
      en: {
        translation: {
          ...
          "tm_free_medical_care": "Tigran the Great Medical Center provides state-guaranteed free outpatient medical care and services in accordance with the decision No. 318-N of the Government of Armenia.",
        },
      },
      hy: {
        translation: {
          ...
          "hero_care": "Մենք այստեղ ենք, որպեսզի ապահովենք ձեր առողջության անվտանգությունը",
          ...
          "doctor_key": 'Բժիշկ',
          "care_key": "Մենք այստեղ ենք, որպեսզի ապահովենք ձեր առողջության անվտանգությունը",
          ...
          "tm_clinic_info_key": "Տիգրան Մեծ ԱԿ ցուցաբերվում է բարձրակարգ, ժամանակակից բժշկական օգնություն:",
          ...
          "tm_free_medical_care": "Երևանի «Տիգրան Մեծ» ԱԿ ՓԲԸ հիմնադրվել է 1959 թվականին և հանդիսանում է «Թիվ 17 պոլիկլինիկա» ՓԲԸ-ի իրավահաջորդը։ 2022 թվականին վերանվանված «Տիգրան Մեծ» ԱԿ-ի մեծ թիմին միացավ «Սարի Թաղ պոլիկլինիկա» ՓԲԸ-ն՝ որպես ստորաբաժանում, որը գործում է Էրեբունի վարչական շրջանում, Սարի Թաղ 10-րդ փողոց, 11 շենք հասցեում։ Ունենալով երկար տարիների փորձ՝ մենք քայլում ենք ժամանակին համընթաց։",
        }
      },
      ru: {
        translation: {
          ...
          "tm_free_medical_care": "Центр здоровья «Тигран Великий» предоставляет населению гарантированную государством бесплатную амбулаторную медицинскую помощь и обслуживание в соответствии с решением № 318-Н правительства РА."
        }
      }
    },
