        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <ServicesTwoSingleItem
              ...
              about="Գինեկոլոգիական բաժանմունքում իրականացվում է գինեկոլոգիական հիվանդությունների ախտորիշում և կոնսերվատիվ բուժում ինչպես նաև հղիների նախածննդյան և հետծննդյան հսկողություն:"
            />
            <ServicesTwoSingleItem
              icon="4"
              image="4"
            ...
            <ServicesTwoSingleItem
              ...
              about="Նեղ մասնագիտական բաժանմունքը բժշկական հաստատության կառույցի բաղկացուցիչ մասն է, որը կենտրոնանում է բժշկության որևէ կոնկրետ ուղղության խորացված ուսումնասիրության, ախտորոշման, բուժման և մասնագիտական պատրաստման վրա։"
            />
            <ServicesTwoSingleItem
              icon="6"
              image="6"
              title={t("Ռենտգենոլոգիական բաժանմունք")}
              about="Ռենտգենոլոգիական բաժանմունքը զինված է ժամանակակից սարքավորումներով և ապահովում է ճշգրիտ ախտորոշում՝ օգտագործելով ռենտգենյան ճառագայթներ։ Այստեղ իրականացվում են տարբեր տեսակի պատկերի ստացման հետազոտություններ՝ ներառյալ կրծքավանդակի, հոդերի, ողնաշարի և այլ օրգանների ռենտգեն հետազոտություններ։ "
            />
          </div>
        </div>
      </section>
